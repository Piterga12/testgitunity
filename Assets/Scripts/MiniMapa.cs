    ...
    void Update()
    {
        ...
        Matrix4x4 PlayerMatrix = gameCamera.localToWorldMatrix* Matrix4x4.Translate(cameraOffset)
            * Matrix4x4.Scale(Vector3.one * scale) *
            Matrix4x4.Translate(playerC) * Matrix4x4.Scale(Vector3.one * dotsScale);
        ...
        for(int i = 0; i < enemies.Length; i++)
        {
            ...
            Matrix4x4 enemyMatrix = gameCamera.localToWorldMatrix *  Matrix4x4.Scale(Vector3.one *scale) *
